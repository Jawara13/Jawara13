...
**Développeur Full Stack & Data Scientist | DTS Informatique · Licence Économie Appliquée**

</div>

Jeune professionnel polyvalent avec une solide formation en informatique et en économie appliquée. Titulaire d'un **DTS en Informatique**, d'un **certificat en analyse de données**, d'un **certificat en intelligence artificielle** et d'une **licence en économie appliquée**, j'allie compétences techniques avancées et expertise analytique pour résoudre des problématiques complexes.

Passionné par l'extraction d'insights à partir de données, l'automatisation et l'innovation technologique, je suis motivé à contribuer à des projets stratégiques dans des environnements dynamiques et innovants.
...
> Retrouvez l'ensemble de mes projets et réalisations sur mon profil GitHub :
> **[github.com/Jawara13](https://github.com/Jawara13)**
...
- 🖥️ Développement de la plateforme web d'administration
- 📱 Développement des applications mobiles Android et iOS
- 🎓 Gestion des établissements, élèves, enseignants, parents, notes, bulletins et emplois du temps
- 🔌 Conception des API REST et de la base de données
...
| Plateforme | Lien |
|---|---|
| 🌐 Site Web | [gestionecole.site](https://gestionecole.site/) |
| 🤖 Android | [Google Play Store](https://play.google.com/store/apps/details?id=gestion.site) |
| 🍎 iOS | [Apple App Store](https://apps.apple.com/sn/app/gestion-school/id6761186157?l=fr-FR) |
...
| Plateforme | Lien |
|---|---|
| 🌐 Site Web | [senjeunesplus.app](https://senjeunesplus.app/) |
| 🤖 Android | [Google Play Store](https://play.google.com/store/apps/details?id=com.senjeunes.app&pcampaignid=web_share) |
